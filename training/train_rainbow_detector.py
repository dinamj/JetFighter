...
# paths
DATA_YAML = Path("data/rainbow_dataset/data.yaml")
...
results = model.train(
    ...
    batch=BATCH_SIZE,
    imgsz=IMAGE_SIZE,
    project='models/rainbow_training',
    name='yolo_rainbow',
    device=DEVICE,
    save=True,
    plots=True, # reason for all the plots of training metrics in models/rainbow_training/yolo_rainbow/
    verbose=True
)
...
best_model_path = Path("models/rainbow_training/yolo_rainbow/weights/best.pt")
output_model_path = MODEL_OUTPUT_DIR / "rainbow_detector.pt"
...
print(f"Training logs: models/rainbow_training/yolo_rainbow/")
