...
# paths
DATA_YAML = Path("data/detector_dataset/data.yaml")
...
results = model.train(
    ...
    batch=BATCH_SIZE,
    imgsz=IMAGE_SIZE,
    project='models/detector_training',
    name='yolo_detector',
    device=DEVICE,
    save=True,
...
best_model_path = Path("models/detector_training/yolo_detector/weights/best.pt")
...
print(f"Training logs: models/detector_training/yolo_detector/")
